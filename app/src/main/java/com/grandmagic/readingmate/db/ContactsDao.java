...
import com.grandmagic.readingmate.bean.response.Contacts.AvatarCoverter;
import com.grandmagic.readingmate.bean.response.Contacts.AvatarUrlBean;
...
public class ContactsDao extends AbstractDao<Contacts, Long> {
    ...
    private final AvatarCoverter avatar_urlConverter = new AvatarCoverter();
    ...
    protected final void bindValues(DatabaseStatement stmt, Contacts entity) {
        ...
        AvatarUrlBean avatar_url = entity.getAvatar_url();
        if (avatar_url != null) {
            stmt.bindString(3, avatar_urlConverter.convertToDatabaseValue(avatar_url));
        }
    ...
    public Contacts readEntity(Cursor cursor, int offset) {
        Contacts entity = new Contacts( //
            ...
            cursor.isNull(offset + 2) ? null : avatar_urlConverter.convertToEntityProperty(cursor.getString(offset + 2)), // avatar_url
    ...
    public void readEntity(Cursor cursor, Contacts entity, int offset) {
        ...
        entity.setAvatar_url(cursor.isNull(offset + 2) ? null : avatar_urlConverter.convertToEntityProperty(cursor.getString(offset + 2)));
