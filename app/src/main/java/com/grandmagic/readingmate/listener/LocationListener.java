...
/**
 * Created by lps on 2017/2/17.
 */

public class LocationListener implements BDLocationListener {
    private Handler mLocationHandler;

    public LocationListener(Handler mLocationHandler) {
    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        sb.append("\ngetCountry" + location.getCountry()+"countrycode"+location.getCountryCode());
        sb.append("\ngetcity" + location.getCity()+"countrycode"+location.getCityCode());
        sb.append("\ngetcity" + location.getCity()+"countrycode"+location.getCityCode());
        sb.append("\ngetcity" + location.getAddress().district+"countrycode"+location.getAddress().street);
