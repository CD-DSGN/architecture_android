...
public class MainActivity extends AppBaseActivity {
    ...
    private void perform() {
        ...
        novate.get("v2/movie/top250", parameters, new BaseSubscriber<ResponseBody>(MainActivity.this) {
            @Override
            public void onError(Throwable e) {
                Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void performPost() {
         ...
         * 参考 performGet()中的方式
         */
        novate.post("service/getIpInfo.php", parameters, new BaseSubscriber<ResponseBody>(MainActivity.this) {
    ...
    private void perform_Api() {
        ...
        novate.call(myAPI.getSougu(parameters),
                new BaseSubscriber<SouguBean>(MainActivity.this) {
    ...
    private void performUpLoadImage() {
        ...
        novate.upload(url, requestFile, new BaseSubscriber<ResponseBody>(MainActivity.this) {
            @Override
            public void onError(Throwable e) {
                Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        ...
        novate.uploadImage(url, new File(mPath), new BaseSubscriber<ResponseBody>(MainActivity.this) {
            @Override
            public void onError(Throwable e) {
                Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void performUpLoadFlie() {
        ...
        novate.uploadFlie(url, description,  body, new BaseSubscriber<ResponseBody>(MainActivity.this) {
            @Override
            public void onError(Throwable e) {
                Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void performUpLoadFlies() {
        ...
        novate.uploadFlies(url, maps, new BaseSubscriber<ResponseBody>(MainActivity.this) {
            @Override
            public void onError(Throwable e) {
                Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void performDown() {
        ...
        novate.download(downUrl, new DownLoadCallBack() {
            ...
            public void onSucess(String key, String path, String name, long fileSize) {
                Toast.makeText(MainActivity.this, "download  onSucess", Toast.LENGTH_SHORT).show();
    ...
    private void performDownMin() {
        ...
        novate.downloadMin(downUrl, new DownLoadCallBack() {
            ...
            public void onStart(String key) {
                super.onStart(key);
                Toast.makeText(MainActivity.this, "download is start", Toast.LENGTH_SHORT).show();
